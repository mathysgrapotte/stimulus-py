...
@pytest.fixture
def vcc_dataset() -> H5adDataset:
    """Load the VCC subset dataset."""
    return H5adDataset.load_from_disk(VCC_SUBSET_PATH)


def test_target_gene_splitter_with_list(vcc_dataset: H5adDataset) -> None:
...
def test_target_gene_splitter_with_ratio(vcc_dataset: H5adDataset) -> None:
...
def test_target_gene_splitter_with_api(vcc_dataset: H5adDataset) -> None:
